    ...
    <Box>
      ...
      >
        ...
        <CardMedia
          ...
          src={image6}
          alt=""
          sx={{ width: !isMobile ? "50%" : "100%", height: "100%" }}
        />
      </Box>
      <Box
        sx={{
      ...
      >
        ...
        <Box sx={{ width: isMobile ? "100%" : "50%", display: "flex", flexWrap: "wrap", flexDirection: "row" }}>
          {contacts.map((item) => (
            <Box
              sx={{
                display: "flex",
                width: isMobile? "100%" : "50%",
                height: isMobile? "150px" : "50%",
                alignItems: "center",
                justifyContent: "center",
                transition: "0.5s",
