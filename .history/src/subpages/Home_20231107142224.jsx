  ...
  const items1 = [
    {
      ...
      icon: <PhoneIcon sx={{ color: lime[400], fontSize: "50px", mr: "1rem" }} />,
    },
    {
      title: "SERVICES",
      text: "Check our list of services",
      icon: <MedicalServicesIcon sx={{ color: lime[400], fontSize: "50px", mr: "1rem" }} />,
    },
    {
      title: "TEST RESULTS",
      text: "Check your results online",
      icon: <BiotechIcon sx={{ color: lime[400], fontSize: "50px", mr: "1rem" }} />,
    },
  ];
      ...
      >
        {items1.map((item) => (
          ...
          >
            ...
            <ArrowForwardIosIcon sx={{ color: lime[400], fontSize: "16px", ml: "1rem" }} />
          </Box>
        ))}
      </Box>
    ...
    <Box>
      ...
      <Box sx={{ boxSizing: "border-box", px: "160px", py: "120px" }}>
        ...
        <Box sx={{ display: "flex", width: "50%" }}>
          ...
          <Box sx={{ p: "1rem" }}>
            <Typography variant="h5" sx={{ mb: "1rem" }} color={lime[900]}>
      ...
      <Box sx={{ backgroundColor: lime[500], boxSizing: "border-box", px: "160px", py: "6rem" }}>
            ...
            >
              ...
              <Typography
                sx={{
                  ...
                  fontWeight: 900,
                  textAlign: "center",
                  borderBottom: "1px solid " + lime[400],
                  margin: "0 auto",
                  left: 0,
                  right: 0,
                  width: "75%",
      ...
      <Box sx={{ display: "flex", width: "100%", backgroundColor: lime[400], height: "600px" }}>
        <Box sx={{ width: "50%" }}>
          <iframe
          ...
          {contacts.map((item) => (
            <Box
              sx={{
                ...
                alignItems: "center",
                justifyContent: "center",
                outline: "1px solid " + lime[500],
                transition: "0.5s",
                ":hover": { backgroundColor: lime[300], cursor: "pointer" },
              }}
            >
