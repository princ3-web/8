  ...
  const items0 = [
    {
      ...
      text: "Preventive dentistry focuses on maintaining oral health and preventing dental issues through regular check-ups, cleanings, and patient education.",
      icon: icon1,
    },
    {
      title: "Cosmetic Dentistry",
      text: "Cosmetic dentistry offers procedures and treatments aimed at improving the appearance of the teeth and smile, such as teeth whitening, veneers, and orthodontic options.
