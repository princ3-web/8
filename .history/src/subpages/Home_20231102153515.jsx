  ...
  return (
    <Box>
      ...
      <Box sx={{ backgroundColor: grey[200], display: "flex" }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", flexWrap:"wrap", width:"100%", p:"4rem" }}>
          <Box sx={{width:"50%", height:"50%"}}>
            <CardMedia component="img" src={image5} alt="" sx={{ width: "50px", height: "50px" }} />
