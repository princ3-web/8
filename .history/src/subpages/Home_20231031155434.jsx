...
const Home = () => {
  ...
  return (
    <Box>
      ...
      <Box sx={{ position: "absolute", top: "50%", left: "160px", border: "1px solid red" }}>
      ...
      >
        <Box sx={{ backgroundColor: grey[100], width: "25%", height: "300px" }}>abadbb</Box>
        <Box sx={{ display: "flex", width: "100%" }}>
          {items0.map((item) => (
            <Box sx={{ display:"flex", justifyContent:"center", alignItems:"CENTER" backgroundColor: blue[400], width: "25%", height: "300px", }}>
              <Typography>
              {item.title}
              </Typography>
            </Box>
