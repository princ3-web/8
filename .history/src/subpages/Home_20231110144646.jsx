...
const Home = ({isMobile}) => {
  ...
  return (
    <Box>
      ...
      <Box sx={{ boxSizing: "border-box", px: !isMobile ?  "160px" : "10px", py: "120px", border:"1px solid red" }}>
        <Typography variant="h3">Who we are</Typography>
        <Box sx={{ display: "flex", width: "50%", flexDirection: !isMobile ? "row" :"column" }}>
          <CardMedia
            component="img"
            src={image1}
            alt=""
      ...
      <Box sx={{ backgroundColor: grey[200], display: "flex", flexDirection: !isMobile? "row" :"colu"}}>
      ...
      <Box sx={{ backgroundColor: brown[500], boxSizing: "border-box", px: "160px", py: "6rem" }}>
