  ...
  const items1 = [
    {
      ...
      icon: <PhoneIcon sx={{ color: green[400], fontSize: "50px", mr: "1rem" }} />,
    },
    {
      title: "SERVICES",
      text: "Check our list of services",
      icon: <MedicalServicesIcon sx={{ color: green[400], fontSize: "50px", mr: "1rem" }} />,
    },
    {
      title: "TEST RESULTS",
      text: "Check your results online",
      icon: <BiotechIcon sx={{ color: green[400], fontSize: "50px", mr: "1rem" }} />,
    },
  ];
      ...
      >
        {items1.map((item) => (
          ...
          >
            ...
            <ArrowForwardIosIcon sx={{ color: green[400], fontSize: "16px", ml: "1rem" }} />
          </Box>
        ))}
      </Box>
...
const Home = () => {
  ...
  const contacts = [
    { title: "LOCATION", text: ["17 N, CHARLES STREET BALTMORE", "MD21202"] },
    { title: "OUR HOURS", text: ["MON-FRI: 09:00-18:00", "MON-FRI: 09:00-18:00"] },
    { title: "CONTACT US", text: ["+4 01800 1234",  "YOUREMAIL@GMAIL.COM"] },
    { title: "FOLLOW US", text: ["FACEBOOK"] },
  ];
    ...
    <Box>
      ...
      <Box sx={{ boxSizing: "border-box", px: "160px", py: "120px" }}>
        ...
        <Box sx={{ display: "flex", width: "50%" }}>
          ...
          />
          <Box sx={{ p: "1rem" }}>
            <Typography variant="h5" sx={{ mb: "1rem" }} color={green[900]}>
      ...
      <Box sx={{ backgroundColor: green[500], boxSizing: "border-box", px: "160px", py: "4rem" }}>
      ...
      >
        <Typography
          variant="h5"
          sx={{ width: "40%", textAlign: "center", fontWeight: 900, mb: "2rem" }}
        >
      ...
      <Box sx={{ display: "flex", width: "100%", backgroundColor: green[400], height: "600px" }}>
        <Box sx={{ width: "50%" }}>
          <iframe
          ...
          {contacts.map((item) => (
            ...
            >
              <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                <Typography color={grey[100]} sx={{mb:"1rem", fontSize:"18px"}}>{item.title}</Typography>
                {item.text.map((i) => (
                  <Typography color={grey[100]} sx={{fontSize:"12px"}}>{i}</Typography>
                ))}
              </Box>
            </Box>
          ))}
