    ...
    <Box>
      ...
      <Box>
        ...
        <CardMedia
                ...
                sx={{ width: "40px", mr: "1rem" }}
              />
          <CardMedia component="img" src="image1" alt="" sx={{width:"300px", height:"300px"}}/>
          <Box>
          <Typography>
              MedLife Care is the premier health care company focused on delivering the highest
              quality care
            </Typography>
          </Box>
            <Typography>to people with chronic conditions. Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation. Quis nostrud exercitation ullamco laboris nisi ut aliquip ex.</Typography>
          </Box>
        </Box>
    </Box>
  );
