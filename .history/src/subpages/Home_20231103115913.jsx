  ...
  const items1 = [
    {
      ...
      icon: <PhoneIcon sx={{ color: purple[400], fontSize: "50px", mr: "1rem" }} />,
    },
    {
      title: "SERVICES",
      text: "Check our list of services",
      icon: <MedicalServicesIcon sx={{ color: purple[400], fontSize: "50px", mr: "1rem" }} />,
    },
    {
      title: "TEST RESULTS",
      text: "Check your results online",
      icon: <BiotechIcon sx={{ color: purple[400], fontSize: "50px", mr: "1rem" }} />,
    },
  ];
      ...
      >
        {items1.map((item) => (
          ...
          >
            ...
            <ArrowForwardIosIcon sx={{ color: purple[400], fontSize: "16px", ml: "1rem" }} />
          </Box>
        ))}
      </Box>
    ...
    <Box>
      ...
      <Box sx={{ boxSizing: "border-box", px: "160px", py: "120px" }}>
        ...
        <Box sx={{ display: "flex", width: "50%" }}>
          ...
          />
          <Box sx={{ p: "1rem" }}>
            <Typography variant="h5" sx={{ mb: "1rem" }} color={purple[900]}>
      ...
      <Box sx={{ backgroundColor: purple[500], boxSizing: "border-box", px: "160px", py: "4rem" }}>
            ...
            >
              ...
              <Typography
                sx={{
                  ...
                  fontWeight: 900,
                  textAlign: "center",
                  borderBottom: "1px solid " + purple[400],
                  margin: "0 auto",
                  left: 0,
                  right: 0,
                  width: "75%",
