    ...
    <Box>
      ...
      <Box sx={{ boxSizing: "border-box", px: "160px", py: "120px" }}>
        ...
        <Box sx={{ display: "flex",  width:"50%" }}>
          ...
          At Prodent Dentist Services, we believe in the importance of personalized care. We take the time to listen to your concerns, answer your questions, and tailor our services to your unique needs. Whether you require a simple dental cleaning or more complex procedures, our commitment to excellence remains unwavering.
