...
const Home = () => {
  ...
  return (
    <Box>
      ...
      <Box sx={{ backgroundColor: blue[400], boxSizing:"border-box", px:"160px", py:"4rem" }}>
        <Typography variant="h4" sx={{color: grey[100], mb:"2rem"}}>Services</Typography>
        <Grid container sx={{width:"50%"}}>
          {services.map((item, index) => (
            <Grid item lg={6} key={index}>
              <Typography variant="body1" sx={{color: grey[100], mb:"1rem"}}> {item}</Typography>
            </Grid>
          ))}
        </Grid>
      </Box>
