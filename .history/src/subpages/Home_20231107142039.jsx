  ...
  const items1 = [
    {
      ...
      icon: <PhoneIcon sx={{ color: cyan[400], fontSize: "50px", mr: "1rem" }} />,
    },
    {
      title: "SERVICES",
      text: "Check our list of services",
      icon: <MedicalServicesIcon sx={{ color: cyan[400], fontSize: "50px", mr: "1rem" }} />,
    },
    {
      title: "TEST RESULTS",
      text: "Check your results online",
      icon: <BiotechIcon sx={{ color: cyan[400], fontSize: "50px", mr: "1rem" }} />,
    },
  ];
      ...
      >
        {items1.map((item) => (
          ...
          >
            ...
            <ArrowForwardIosIcon sx={{ color: cyan[400], fontSize: "16px", ml: "1rem" }} />
          </Box>
        ))}
      </Box>
    ...
    <Box>
      ...
      <Box sx={{ boxSizing: "border-box", px: "160px", py: "120px" }}>
        ...
        <Box sx={{ display: "flex", width: "50%" }}>
          ...
          <Box sx={{ p: "1rem" }}>
            <Typography variant="h5" sx={{ mb: "1rem" }} color={cyan[900]}>
      ...
      <Box sx={{ backgroundColor: cyan[500], boxSizing: "border-box", px: "160px", py: "6rem" }}>
      ...
      <Box sx={{ display: "flex", width: "100%", backgroundColor: cyan[400], height: "600px" }}>
        <Box sx={{ width: "50%" }}>
          <iframe
          ...
          {contacts.map((item) => (
            <Box
              sx={{
                ...
                transition: "0.5s",
                ":hover": { backgroundColor: cyan[300], cursor: "pointer" },
              }}
            >
