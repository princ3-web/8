  ...
  return (
    <Box>
      ...
      <Box sx={{ boxSizing: "border-box", px: "160px", py: "120px" }}>
        <Typography variant="h3" color={blue[900]}>Who we are</Typography>
        <Box sx={{ display: "flex",  width:"50%" }}>
          ...
          <Box sx={{p:"1rem"}}>
            ...
            Prodent Dentist Services is a leading dental care provider committed to delivering exceptional and comprehensive oral healthcare to our valued patients. With a steadfast dedication to your dental well-being, we take pride in offering a wide range of top-tier services to ensure your smile remains healthy, radiant, and confident.


            </Typography>
          
          <Typography  variant="subtitle2">
            to people with chronic conditions. Lorem ipsum dolor sit amet conse ctetur adipisicing
            elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
            minim veniam, quis nostrud exercitation. Quis nostrud exercitation ullamco laboris nisi
            ut aliquip ex.
          </Typography>
          </Box>
        </Box>
